...
namespace Braintree.Tests
{
    ...
    public class PayPalAccountTest
    {
        ...
        {
            Assert.Throws<NotFoundException>(() => gateway.PayPalAccount.Find(" "));
        }
        ...
        public void Find_RaisesNotFoundErrorForCreditCardToken()
        {
            ...
            Assert.Throws<NotFoundException>(() => gateway.PayPalAccount.Find(customer.CreditCards[0].Token));
        }
        ...
        {
            Assert.Throws<NotFoundException>(() => gateway.PayPalAccount.Delete(" "));
        }
