...
namespace Braintree
{
    public enum ValidationErrorCode
    {
        ...
        TRANSACTION_SERVICE_FEE_AMOUNT_CANNOT_BE_NEGATIVE = 92501,
        TRANSACTION_SERVICE_FEE_AMOUNT_IS_REQUIRED = 92502,
        TRANSACTION_SERVICE_FEE_AMOUNT_IS_TOO_LARGE = 92504,
        TRANSACTION_SERVICE_FEE_IS_NOT_ALLOWED_ON_CREDITS = 91552,
        TRANSACTION_SERVICE_FEE_MERCHANT_ACCOUNT_CANNOT_MATCH_TRANSACTION_MERCHANT_ACCOUNT = 92507,
        TRANSACTION_SERVICE_FEE_MERCHANT_ACCOUNT_CURRENCIES_MUST_MATCH = 92508,
        TRANSACTION_SERVICE_FEE_MERCHANT_ACCOUNT_ID_IS_INVALID = 92506,
        TRANSACTION_SERVICE_FEE_MERCHANT_ACCOUNT_NOT_SUPPORTED = 92505,
