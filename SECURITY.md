...
We release security patches for the following versions of the Braintree .NET library:
...
Security patches are only applied to **Active** versions. We recommend upgrading to 5.x.x if you are on an older version.
