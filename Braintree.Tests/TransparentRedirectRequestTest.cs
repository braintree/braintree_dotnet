...
namespace Braintree.Tests
{
    ...
    class TransparentRedirectRequestTest
    {
        ...
        {
            Assert.Throws<ForgedQueryStringException>(() => new TransparentRedirectRequest("http_status=300&id=6kdj469tw7yck32j&hash=99c9ff20cd7910a1c1e793ff9e3b2d15586dc6b9" + "this makes it invalid"));
        }
        ...
        {
            Assert.Throws<ServerException>(() => new TransparentRedirectRequest("http_status=500&id=6kdj469tw7yck32j&hash=a839a44ca69d59a3d6f639c294794989676632dc"));
        }
